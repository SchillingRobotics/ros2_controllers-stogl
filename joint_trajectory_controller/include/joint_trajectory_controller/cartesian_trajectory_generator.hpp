...
#include "cartesian_trajectory_generator_parameters.hpp"
...
{
/**
 * Interpolator in Cartesian space.
 *
 * Optionally it can work with position values in the global coordinate systems and velocity values
 * in local coordinate system. This is useful functionality when working with mobile robots.
 */
